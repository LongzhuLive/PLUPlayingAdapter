#
#  Be sure to run `pod spec lint PLUPlayingAdapter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    龙珠直播的PLUPlayingAdapter
                   DESC

  s.homepage     = "https://github.com/LongzhuLive/PLUPlayingAdapter"
  ...
  s.source       = { :git => "https://github.com/LongzhuLive/PLUPlayingAdapter.git", :tag => "#{s.version}" }
  ...
  #
    ...
    s.requires_arc = true
    s.ios.vendored_frameworks = "PLUPlayingAdapter.framework"
